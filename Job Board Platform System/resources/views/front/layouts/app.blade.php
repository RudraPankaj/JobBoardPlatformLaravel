...
<head>
	...
	<title>CareerConnect | Find Best Jobs</title>
...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="{{ route('home') }}">CareerConnect</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				@else
					@if (Auth::user()->role == 'admin')
						<span class="mrgn5-30">Hi, Admin</span>
					@else
						<span class="mrgn5-30">Hi, {{ Auth::user()->name }}</span>
					@endif
					@if (Auth::user()->role == 'admin')
