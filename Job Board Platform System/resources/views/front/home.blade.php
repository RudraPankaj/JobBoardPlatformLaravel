...
@section('main')
<section class="section-0 lazy d-flex dark align-items-center" data-bg="{{ asset('assets/images/banner6.jpg') }}" style="background-size: cover;">
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                <h1>Connect your dream career</h1>
...
<section class="section-3  py-5" id="jobs">
    <div class="container">
        <h2>Featured Jobs</h2>
        <div class="row pt-5">
